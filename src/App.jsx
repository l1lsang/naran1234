...
export default function App() {
  return (
    <div className="app">
      ...
      <section className="고객사례">
        <div className="inner 고객사례-inner">
          <div className="두달락">
            ...
            <div className="대박표">
              <img src={진행전} className="진행전" alt="진행 전" />
              <img src={화살표} className="화살표" alt="화살표" />
              <img src={진행후} className="진행후" alt="진행 후" />
            </div>
          </div>
        </div>
      </section>
      ...
      {/* ================== 진행 불가 안내 ================== */}
      <section className="고객안내">
        <div className="inner">
          <h2 className="고객">회생, 회복, 파산 최근 5년 이내 진행자는 진행 불가</h2>
        </div>
      </section>
